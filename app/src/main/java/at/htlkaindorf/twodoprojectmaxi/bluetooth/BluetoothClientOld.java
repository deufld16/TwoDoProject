...
public class BluetoothClientOld
{
    ...
    public BluetoothClientOld(BluetoothManager bm, BluetoothAdapter bluetoothAdapter, TransferActivity srcActivity, UUID THE_UUID) {
        this.bm = bm;
    ...
    private class ConnectThread extends Thread {
        ...
        {
            //bt = new BluetoothTransferOld(socket, srcActivity, false);
            //bt.start();
        }
